...
This is a simple RAG retrieval — contexts are retrieved by vector similarity search only (no graph traversal or hybrid search).
...
export async function simpleAnswerWithContext(question, hits) {
